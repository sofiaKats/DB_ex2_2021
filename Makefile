...
ht:
	@echo " Compile ht_main ...";
	gcc -I ./include/ -g -L ./lib/ -Wl,-rpath,./lib/ ./examples/ht_main.c ./src/hash_file.c ./src/blocks.c ./src/buckets.c ./src/structures.c ./lists/block_list.c ./lists/bucket_list.c -lbf -o ./build/runner -O2
